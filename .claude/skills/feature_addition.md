...
2. **Coding**:
   ...
   - After coding is done, go to **Testing** phase for verification.
3. **Testing**:
   - Delegate to @validator to write googletest-based test cases. Ensure implementation correctness.
   - Reach 100% code coverage on code additions and modifications.
   - If any test fails, first check if the test case is written correctly.
   - Notify @developer about the details of the failure and ask for a code update.
   - After all tests pass, go to **Security Audit** phase.
4. **Security Audit**
